...
class Settings(BaseSettings):
    ...
    QDRANT_DB_HOSTS_JSON_PATH : str = os.getenv("QDRANT_DB_HOSTS_JSON_PATH",f"{BASE_DIR}/config/hosts.json")
    QDRANT_DB_COLLECTIONS_JSON_PATH : str = os.getenv("QDRANT_DB_COLLECTIONS_JSON_PATH",f"{BASE_DIR}/config/collections.json")
